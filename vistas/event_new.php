	...
	<div class="container pb-6 pt-6">
		...
		<form action="./php/evento_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		<div class="columns">
			<div class="column">
					<div class="control">
						<label>Nombre</label>
			...
			<div class="columns">
				<div class="column">
					<div class="control">
						<label>Link</label>
						<input class="input" type="text" name="link" maxlength="100" placeholder="Enlace para la inscripcion del evento" >
					</div>
				</div>	
				<div class="column">
					<div class="control">
						<label>Costo Afiliados</label>
						<input class="input" type="text" name="cost_sub" pattern="[0-9.]{0,25}" maxlength="9" placeholder="Ingrese el costo para afiliados (ej:60000)">
					</div>
				</div>	
				<div class="column">
					<div class="control">
						<label>Costo Normal</label>
						<input class="input" type="text" name="cost_initial" pattern="[0-9.]{0,25}" maxlength="9"  placeholder="Ingrese el costo normal (ej:60000)"  >
					</div>
				</div>	
			</div>
