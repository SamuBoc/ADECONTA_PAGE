<style>
    * ----- HEADER SECTION ----- */ @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700&display=swap');
    ...
    * {
    ...
    .header {
        ...
        /* Definimos el contenedor para las consultas */
    ...
    .header__logo {
        ...
        margin: 10px 20px;
        cursor: pointer;
        /* Cambia el cursor a una mano al pasar sobre el logo */
